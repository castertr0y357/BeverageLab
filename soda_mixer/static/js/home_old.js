...
function updateSelectedArea(isDone = false) {
    ...
    function setCreationMethod(method) {
        ...
        document.getElementById('methodIdleContainer').style.display = 'none';
        document.getElementById('aiQuickContainer').style.display = 'none';
        document.getElementById('aiVibeContainer').style.display = 'none';
        document.getElementById('stepContainer').style.display = 'none';
        
        if (!method) {
            document.getElementById('methodIdleContainer').style.display = 'block';
        } else if (method === 'quick') {
            document.getElementById('aiQuickContainer').style.display = 'block';
            const list = document.getElementById('quickDrinksList');
            if (list.children.length === 0) {
                generateQuickRecommendations();
            }
        } else if (method === 'vibe') {
            document.getElementById('aiVibeContainer').style.display = 'block';
            document.getElementById('vibeDrinkResult').innerHTML = '';
            document.getElementById('vibePromptInput').value = '';
